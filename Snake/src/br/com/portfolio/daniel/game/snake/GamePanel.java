...
public class GamePanel extends JPanel implements ActionListener {
	...
	/**
	 * o for desenha um grid na tela e quem define o tamanho do grid é o UNIT_SIZE
	 * 
	 * @param g
	 */
	public void draw(Graphics g) {
		...
		if (running) {
			...
			for (int i = 0; i < bodyParts; i++) {
				...
				g.setColor(Color.RED);
				g.setFont(new Font("Congenial",Font.PLAIN,40));
	...
	private void checkCollisions() {
		...
		/**
		 * checa se a cabeça colidiu com a borda
		 */
	...
	private void gameOver(Graphics g) {
		...
		g.setColor(Color.RED);
		g.setFont(new Font("Congenial",Font.PLAIN,75));
